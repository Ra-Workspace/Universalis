...
export default {
    cleanHistoryEntry: (entry: MarketBoardHistoryEntry, sourceName?: string): MarketBoardHistoryEntry => {
        ...
        const newEntry = {
            buyerName: entry.buyerName.replace(/[^a-zA-Z가-힣0-9'\- ]/g, ""),
    ...
    cleanListing: (listing: MarketBoardItemListingUpload, sourceName?: string): MarketBoardItemListingUpload => {
        ...
        const newListing = {
            ...
            creatorName: listing.creatorName.replace(/[^a-zA-Z가-힣0-9'\- ]/g, ""),
            ...
            retainerName: listing.retainerName.replace(/[^a-zA-Z가-힣0-9'\- ]/g, ""),
    ...
    validateUploadData: async (args: ValidateUploadDataArgs): Promise<boolean> => {
        ...
        // 2075~2078 for Korean worlds
        if (args.uploadData.worldID && args.uploadData.worldID <= 16 ||
                (args.uploadData.worldID >= 100 && args.uploadData.worldID <= 2074) ||
                args.uploadData.worldID >= 2079 ||
        ...
        if (args.uploadData.listings) args.uploadData.listings.forEach((listing) => {
            if (listing.hq == null ||
                    ...
                    listing.retainerName.match(/[^a-zA-Z가-힣0-9'\- ]/g) ||
        ...
        if (args.uploadData.entries) args.uploadData.entries.forEach((entry) => {
            if (entry.hq == null ||
                    ...
                    entry.buyerName.match(/[^a-zA-Z가-힣0-9'\- ]/g)) {
        ...
        if (args.uploadData.characterName != null && args.uploadData.contentID == null || args.uploadData.characterName == null && args.uploadData.contentID != null) {
            args.ctx.throw(422);
            return true;
        } else if (args.uploadData.characterName != null && (args.uploadData.characterName.length > 32 || args.uploadData.characterName.match(/[^a-zA-Z가-힣0-9'\- ]/g))) {
            args.ctx.throw(422);
            return true;
        }
